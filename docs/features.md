...
- Contact section.
- Footer with ownership, rights, and technical build notes.
- Smooth scrolling, hero entrance motion, section scroll reveals, card stagger reveals, and ambient animated background.
